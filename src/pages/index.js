  ...
  render() {
    return (
      <Layout headerVisible={this.state.headerVisible}>
        <SEO
          lang="en"
          keywords={[`richik`, `richik sc`, `software engineer`]}
        />
        <section className="intro">
          ...
          <div className="intro-text">
            ...
            <p>
              I'm a software engineer on the Windchill team at{" "}
              <a href="https://www.ptc.com/">PTC</a>. I graduated with my
              bachelor's degree in Computer Science from the University of
              Wisconsin-Madison in 2024.
            </p>
            <p>
              Formerly, I was a Technology Development Program Intern at{" "}
              <a href="https://www.optum.com/">Optum</a>, working with a site
              reliability engineering team.
            </p>
            <p>
              Prior to that, I interned at PTC on the{" "}
              <a href="https://www.ptc.com/en/products/vuforia">Vuforia</a> AR
              team.
            </p>
            <p style={{ maxWidth: "600px", marginBottom: `1.45rem` }}>
              I was also a teaching assistant for the undergrad Operating
              Systems course at both UW-Madison and Northeastern.
            </p>
